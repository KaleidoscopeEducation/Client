...
import ClassroomManagementButton from './ClassroomManagementButton';
import StudentDetailsFormButton from './StudentButton';
            ...
            {buttonSpecs.map(({ Component, mode }) => (
              <ModeButton
                ...
                props={{
                  ...
                  modeButtonClassNames: 'basis-1/3 sm:basis-1/3 md:basis-1/3',
                }}
              />
            ))}
          </div> */}
